...
| [alloy-otlp-logs-attributes](alloy-otlp-logs-attributes/README.md) | **Alloy: Process OTLP logs attributes**<br>Demonstrates how to filter and retain only specific log attributes when processing OTLP logs using Grafana Alloy, and how nested attributes will appear in Loki. | 2025-12-03 |
