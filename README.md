...
| [dotnetfx48-demo](dotnetfx48-demo/README.md) | **.NET Framework 4.8 demo**<br>The included Dockerfile shows how to add OpenTelemetry instrumentation to a .NET Framework 4.8 app running inside a Windows container. | N/A |
