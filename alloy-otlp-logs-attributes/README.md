...
Demonstrates how to filter or flatten attributes OTLP logs using Grafana Alloy. Also shows how nested log attributes will appear in Loki.
...
5. **Embeds all _attributes_ in the log line**
...
Log lines then contain embedded attributes, like this:

![Embedded attributes](./embedded_attributes.png)
