...
# Beep boop. I was generated by Claude. I haven't been fully checked for correctness.
...
def generate_table():
    ...
    table_lines = []
    table_lines.append("| Path | Title | Description |")
    table_lines.append("|------|-------|-------------|")
    ...
    for subdir in sorted(subdirs):  # Sort directories for consistent output
        ...
        if os.path.exists(readme_path):
            ...
            if heading and paragraph:
                # Use just the directory name in the display text, but full path in the link
                row = f"| [{subdir}]({readme_path}) | {heading} | {paragraph} |"
